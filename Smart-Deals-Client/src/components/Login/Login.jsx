                ...
                <div className="card bg-base-100 w-full max-w-sm shrink-0 shadow-2xl">
                    <div className="card-body md:w-96 p-10">
                        <div className="text-center lg:text-left">
                            <h1 className="text-5xl font-bold title-gradient-t2b text-center py-2">Login</h1>
                            <p className="py-2.5 text-center">
                                Don't have an account? <Link className='underline text-blue-600' to={"/register"}>Register!</Link>
                            </p>
                        </div>
                        <form onSubmit={handleLoginWithEmail} className="fieldset">
                            ...
                            <input type="submit" className="btn btn-neutral mt-4 general-gradient-l2r border-0" value="Lgin" />
                        </form>
                        <div>
